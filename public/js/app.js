...
function initAdmin() {
  var orderdata = document.querySelector('#orderdata');
  var orders = [];
  var markup;
...
// sirf isi mei module.export dont worked why??????
...
var addtocart = document.querySelectorAll('.function-add');
var cartCounter = document.querySelector('#cartCounter');
function updateCart(dish) {
  // ajax call  here we are using axios
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('./update-cart', dish).then(function (res) {
    console.log(res);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktaste_on_way"] = self["webpackChunktaste_on_way"] || [];
